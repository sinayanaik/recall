...
import { generateLocalDeckId, listLocalDecks, loadDeckFromLibrary, readLocalDeckIndex, writeLocalDeckIndex } from "../library/local-library.js?v=__BUILD__";
import { getQuickNotesDeckId, openQuickNotesBoard, refreshHighlightBackdrop, setQnReturnState, state } from "../main.js?v=__BUILD__";
