...
import { NOTES_BLOCK_PRESENT_RE, classifyCardSyntax, countQuestionHeadings, extractNotesFromMarkdown, hasExplicitCardSyntax, humanizeSourceTitle, inferDeckTitle, normalizeMarkdown, parseCards, removeEmptyHeadingGroups, sourceFileTitle, stripReaderMetadata, titleFromImportHint } from "./import/parse-cards.js?v=__BUILD__";
...
import { captureNotesAnchor, captureSourceAnchor, cardHasNoteLink, createCardFromNotesSelection, jumpToNoteForCurrentCard, notesAnchorPlainText, onAnchorSourceDeck, scheduleNoteJump } from "./notes/anchors.js?v=__BUILD__";
import { caretRectInBackdrop, scheduleNotesCaretCheck, scrollTextareaToOffset } from "./notes/caret.js?v=__BUILD__";
import { commitNotesEditIfActive, discardNotesEditingForDeckSwap, enterNotesEditing, isNotesEditing, isProgrammaticNotesScroll, notesScrolledSource, quizPanel, renderNotesView, renderNotesViewPinned, resetNotesEditingUI, setNotesScrolledSource } from "./notes/notes-view.js?v=__BUILD__";
...
import { SELECTION_TARGETS, activeEditingTarget, activeRenderedTarget, cleanedSelectionFragment, currentNotesSelectionMarkdown, hideNotesSelectionButton, pillSelectionCapture, scheduleNotesSelectionCheck, textWithLineBreaks } from "./notes/selection.js?v=__BUILD__";
import { closeNotesToc, ensureNotesHeadingIds, isNotesTocOpen, notesTocHeadings, notesTocScrollFrame, scrollNotesEditToHeadingIndex, scrollNotesHeadingIntoView, setNotesTocScrollFrame, slugifyHeading, tocPushesNotes, toggleNotesToc, updateNotesTocActive } from "./notes/toc.js?v=__BUILD__";
...
async function commitSeparateDecks() {
  const resolved = importResolvedDecks();
  if (!resolved.length) {
