...
import { activeDeckLoadToken, closeWebDeckExportMenus, downloadTextFile, loadWebDeck } from "./cloud/web-decks.js?v=__BUILD__";
...
import { exportBaseName, formatCardList, normalizeCardStatus, slugifyFileName } from "./export/markdown.js?v=__BUILD__";
...
import { clearBrowserPersistence, deckSnapshot, loadDeckSnapshot } from "./storage/deck-snapshot.js?v=__BUILD__";
import { allDeckSnapshotIds, clearAllDeckSnapshots, cloneSnapshot, deckSnapshotCache, deckStoreChannel, deckStoreRequest, deckStoreUnreadable, deleteDeckSnapshot, flushPendingDeckAutosave, forEachDeckSnapshot, indexedDbUnavailable, initDeckStorage, journalPendingDeckWrites, pendingDeckWrites, readDeckSnapshot, requestPersistentStorage, scheduleDeckAutosave, setDeckStoreChannel, storagePersisted, touchDeckSnapshotCache, withDeckLock, writeDeckSnapshot } from "./storage/deck-store.js?v=__BUILD__";
import { LAST_BG_SYNC_PROBLEM_KEY, LAST_GLOBAL_SYNC_ERROR_KEY, LAST_GLOBAL_SYNC_KEY, LOCAL_DECKS_INDEX_KEY, LOCAL_DECK_PREFIX, LOCAL_DECK_TOMBSTONES_KEY, MISSING_DECK_WATCH_KEY, NOTES_CONFLICT_SUFFIX, clearMissingDeckWatch, reportBackgroundSyncProblem } from "./storage/keys.js?v=__BUILD__";
import { deckAutosaveTimer, handleDeckStorageQuotaError, isQuotaExceededError, lastSaveErrorWasQuota, persistWorkingDeck, setDeckAutosaveStorageFailed, setDeckAutosaveTimer, setLastSaveErrorWasQuota } from "./storage/quota.js?v=__BUILD__";
import { cardSyncSignature, dropTombstonesForLiveCards, mergeCloudCardsIntoSnapshot, recordDeletedCardIds, stampCardSyncState } from "./sync/cards.js?v=__BUILD__";
