...
import { LIST_MARKER_RE, MARK_CLOSE_TAG, MARK_HIGHLIGHT_COLORS, MARK_HIGHLIGHT_DEFAULT, MARK_HIGHLIGHT_HEX, makeHighlightFromSelection, markHighlightSwatchButtonsHtml, markOpenTag, selectionForRenderTarget, toggleMarkColorInText } from "./format/highlight.js?v=__BUILD__";
