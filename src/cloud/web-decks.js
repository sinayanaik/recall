...
import { formatCardList, normalizeCardStatus } from "../export/markdown.js?v=__BUILD__";
...
import { isQuickNotesDeck, quickNoteCategoriesFromMeta, readCachedQuickNoteCategories, readLocalDeckIndex, revokeLocalImageUrls, saveDeckToLibrary, state, syncLocalLibraryMetaForDeck, writeCachedQuickNoteCategories, writeLocalDeckIndex } from "../main.js?v=__BUILD__";
