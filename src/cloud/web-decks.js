...
import { isQuickNotesDeck, quickNoteCategoriesFromMeta, readCachedQuickNoteCategories, revokeLocalImageUrls, state, writeCachedQuickNoteCategories } from "../main.js?v=__BUILD__";
