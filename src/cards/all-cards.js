...
import { afterPaint, cornellCardHtml, createToolbarHtml, enableSyntaxHighlighting, normalizeCardStatus, scheduleDeckAutosave, setDraggedAllCardId, showCard, state } from "../main.js?v=__BUILD__";
