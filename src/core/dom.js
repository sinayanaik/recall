...
export const el = {
  ...
  bucketBtn: document.querySelector("#bucketBtn"),
  bucketPanel: document.querySelector("#bucketPanel"),
  bucketBody: document.querySelector("#bucketBody"),
  bucketRefreshBtn: document.querySelector("#bucketRefreshBtn"),
  closeBucketBtn: document.querySelector("#closeBucketBtn"),
  ...
  notesFoldAllBtn: document.querySelector("#notesFoldAllBtn"),
  ...
  documentPdfSwitcher: document.querySelector("#documentPdfSwitcher"),
  documentAddPdfInput: document.querySelector("#documentAddPdfInput"),
