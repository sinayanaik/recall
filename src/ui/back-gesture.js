...
import { closeAppInfoModal, closeClozePanel, closeHelpModal, closeMainMenu, closeMyDecksMoreMenu, closeQnCatMenu, closeQnCatModal, closeQuickNotesBoard, closeStoragePanel, isMainMenuOpen } from "../main.js?v=__BUILD__";
