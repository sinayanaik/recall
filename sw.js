...
const APP_SHELL = [
  ...
  `./styles/48-reading-chrome.css?v=${STAMP}`,
  `./styles/49-highlights-only.css?v=${STAMP}`,
  ...
  `./src/documents/block-actions-popover.js?v=${STAMP}`,
  ...
  `./src/documents/notebook-migrate.js?v=${STAMP}`,
  ...
  `./src/notes/link-fuzzy.js?v=${STAMP}`,
  ...
  `./src/sync/notes-merge3.js?v=${STAMP}`,
